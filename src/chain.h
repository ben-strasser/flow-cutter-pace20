...
typename std::enable_if<is_id_id_func<L>::value && is_id_func<R>::value && !is_id_id_func<R>::value,
    ArrayIDFunc<typename id_func_image_type<R>::type>>::type
...
typename std::enable_if<
    is_mutable_id_id_func<L>::value && is_id_id_func<R>::value, L>::type
chain(L l, const R& r)
{
...
template <class L, class R>
typename std::enable_if<is_id_id_func<L>::value && !is_mutable_id_id_func<L>::value && is_id_id_func<R>::value,
    ArrayIDIDFunc>::type
chain(const L& l, const R& r)
{
    assert(l.image_count() == r.preimage_count());
